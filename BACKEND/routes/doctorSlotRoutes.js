...
const {generateSlots, getAvailableSlots, getMySlots, blockSlot, unblockSlot} = require("../controllers/doctorSlotController");
...
router.get("/my-slots/:date", authMiddleware, roleMiddleware("doctor"), getMySlots);
